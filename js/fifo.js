...
function summary(id, pagefaults, pages, frames) {
    ...
    summary += `<div class="summary-items">Pages:${pages}</div>`;
    summary += `<div class="summary-items">Frames:${frames}</div>`;
    summary += `<div class="summary-items">Hits:${pages - pagefaults}</div>`;
    summary += `<div class="summary-items">Faults:${pagefaults}</div>`;
    summary += `<div class="summary-items">Hit Ratio:${hitratio}</div>`;
    summary += `<div class="summary-items">Miss Ratio:${missratio}</div>`;
