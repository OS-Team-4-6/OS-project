...
function LJFfn() {
  ...
  for (let i = 1; i < LJFcounter; i++) {
    if (
      document.getElementById("lat" + i) !== undefined &&
      document.getElementById("lbt" + i) !== undefined
    ) {
      console.log(i);
      // mat[i][0] = i;
      mat.push([]);
...
function addLJFRow() {
  $("#ljfTable").append(
    '<tr><td><input disabled type="number" id="lpid' +
      LJFcounter +
      '" placeholder="pid' +
      LJFcounter +
      '" value="' +
      LJFcounter +
      '"/></td><td><input type="number" id="lat' +
      LJFcounter +
      '" placeholder="at' +
      LJFcounter +
      '" /></td><td><input type="number" id="lbt' +
      LJFcounter +
      '" placeholder="bt' +
      LJFcounter +
